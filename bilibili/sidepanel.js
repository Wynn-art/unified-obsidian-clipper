...
function bindEvents() {
  ...
  els.settingsBtn.addEventListener("click", () => chrome.tabs.create({ url: chrome.runtime.getURL("bilibili/options.html") }));
...
function renderInitialState() {
  ...
  if (!providers.length) {
    ...
    document.getElementById("spOpenSettings")?.addEventListener("click", (e) => {
      e.preventDefault();
      chrome.tabs.create({ url: chrome.runtime.getURL("bilibili/options.html") });
    });
    return;
  }
