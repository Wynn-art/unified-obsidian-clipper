...
importScripts(
  "bilibili-digest/settings.js",
  "bilibili-digest/lib/wbi.js",
  "bilibili-digest/lib/bili-api.js",
  "bilibili-digest/lib/transcript.js",
  "bilibili-digest/lib/ai.js",
  "bilibili-digest/lib/ai-provider.js",
  "bilibili-digest/lib/concurrency.js",
  "bilibili-digest/lib/task-manager.js",
  ...
  "bilibili-digest/lib/idb.js",
  "bilibili-digest/lib/learning-store.js",
  "bilibili-digest/lib/cache.js",
  "bilibili-digest/lib/note-db.js",
  "bilibili-digest/lib/ai-transport.js",
  "bilibili-digest/lib/notes-service.js",
  "bilibili-digest/lib/transcript-service.js",
  "bilibili-digest/lib/analysis-service.js",
  "bilibili-digest/lib/qa-retrieval.js",
  "bilibili-digest/lib/qa-citations.js",
  "bilibili-digest/lib/qa-service.js",
);
...
const aiTasks = BILI_TASKS.createTaskManager({
  onChange(task) {
    UNIFIED_BILI_BRIDGE.sendMessage({ action: "aiTaskChanged", task }).catch(() => {});
  },
});
...
const {
  ...
  aiErrorResponse,
  broadcast: (message) => {
    UNIFIED_BILI_BRIDGE.sendMessage(message).catch(() => {});
  },
...
// Toolbar behavior is owned by core-background.js.
...
chrome.runtime.onInstalled.addListener(async ({ reason }) => {
  initializeOnce();
  // Unified settings navigation exposes this module without opening another install tab.
...
async function handleOpenSidePanel(tab) {
  ...
  try {
    ...
    await globalThis.UNIFIED_BILI_PANELS.open(tab, "study");
  } catch (error) {
...
UNIFIED_BILI_BRIDGE.onMessage((message, sender, sendResponse) => {
  ...
  if (message?.action === "openOptions") {
    chrome.tabs.create({ url: chrome.runtime.getURL("bilibili-digest/options.html") });
...
async function loadPromptSection(fileName, heading, variables = {}) {
  ...
  if (!markdown) {
    const response = await fetch(chrome.runtime.getURL(`bilibili-digest/prompts/${fileName}`));
    if (!response.ok) {
