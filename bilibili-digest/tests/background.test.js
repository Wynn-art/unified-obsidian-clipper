...
function createBackground({
  ...
  const context = {
    ...
    fetch: async (url, options = {}) => {
      const target = String(url).replace(/^bilibili-digest\//, "");
  ...
  context.UNIFIED_BILI_BRIDGE = { sendMessage: (...args) => context.chrome.runtime.sendMessage(...args), sendTabMessage: (...args) => context.chrome.tabs.sendMessage(...args), onMessage: (...args) => context.chrome.runtime.onMessage.addListener(...args) };
